...
class Agent:
    ...
    def __init__(
        ...
        # Standard logger for file logging - Init first!
    ...
    async def _chat_internal(
        ...
        # Notify hobby manager of user interaction (pause hobbies) if enabled
        try:
            import os
            if os.getenv("AUTONOMOUS_HOBBY_ENABLED", "true").lower() in ("true", "1", "yes"):
